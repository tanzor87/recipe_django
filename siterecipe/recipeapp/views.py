...
Вареные яйца очистите от скорлупы, порубите ножом.""", 6: """
Натрите на крупной терке твердый сыр.""", 7: """
Сложите все ингредиенты в глубокую миску, добавьте морковь. Посолите салат, поперчите по вкусу, добавьте майонез.""", 8: """
Перемешайте салат и дайте ему несколько минут настояться перед подачей.""", 9: """
Готовый салат с курицей, грибами и морковью по-корейски подавайте сразу же после приготовления."""}},
